# create a csv file and upload it to storage bucket

# create a gen2 cloud function based upon events
mention the details of storage buckets, dataset into cloud function 

# use below python code for it
```python
import pandas as pd
